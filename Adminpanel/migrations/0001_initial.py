    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('b/y', 'b/y'), ('new', 'new')], default='new', max_length=255)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_time', models.CharField(max_length=255)),
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Adminpanel.helpers_task')),
            ],
        ),
        migrations.CreateModel(
            name='Cleaner',
            fields=[
                ...
                ('cleaning_location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Adminpanel.cleaning_location')),
            ],
        ),
    ]
